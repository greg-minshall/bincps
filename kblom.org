...
A common technique for continuous probability distributions is to form
a histogram, "binning" the possible values, and then assigning each
bin a probability.  This histogram can then be displayed, looking
something like the rose-colored bars in the Financial Times [[fig:ftdisplay][display]]
Blom posted.  In the FT display, in 2015, a household income of
