...
The total household income of the United States increased from
...
First we show, in a table form [fn::Also a CDF, by the way], how much
of the total income was earned by different percentiles of households
in the United States, for the years 1972 and 2016.  We see that, for
example, in 1972,
...
#+name: tincdistrbydecile
#+begin_src R :results table :colnames yes :exports results
  <<create.tiles>>
  df <- tiles.main(c("--maxhh", "2e14", "--tgt.in.key", "%totalincome:%population", "--tiles", "0.1,0.25,0.5,0.75,0.9,1"))
  round(df,4)
#+end_src

#+RESULTS: tincdistrbydecile
| Year |    0.1 |   0.25 |    0.5 |   0.75 |    0.9 | 1 |
|------+--------+--------+--------+--------+--------+---|
| 1972 | 0.0169 | 0.0767 | 0.2553 | 0.5286 | 0.7499 | 1 |
| 2016 | 0.0089 | 0.0529 | 0.1887 | 0.4355 | 0.6755 | 1 |
