...
#+begin_src R :results table :colnames yes :exports results
  <<create.tiles>>
  df <- tiles.main(c("--ifile", ifile, "--maxhh", "2e14", "--tgt.in.key", "%totalincome:%population", "--tiles", "0.1,0.25,0.5,0.75,0.9,1"))
  round(df,4)
#+end_src
...
#+BEGIN_SRC sh :tangle create.tidistrbybracket :shebang "#!/bin/sh" :results none :exports none :eval never
  ./create.ecdf.common $* --years 1972,2016 --tgt.in.key %totalincome:bracket --maxhh 2e14
#+END_SRC
