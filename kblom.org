...
#+begin_src R :exports none :eval no-export
  <<comprss>>
  doprint <- function(vals, words=words, docomprss, format) {
      if (docomprss) {
...
#+name: lucr
#+BEGIN_SRC R :exports none :var tgtinkey="totalincome:%population" :var keys="1" :var years="1972,2016" :var ifile=ifile :var words="FALSE" :var docomprss="TRUE" :var format="" :var diff=1
  <<lookup>>
  <<doprint>>
  ...
  doprint(vals, words=words, docomprss=docomprss, format=format)
#+END_SRC
...
#+name: tincbypop
#+begin_src sh :exports results :results output table raw :cache yes
...
#+RESULTS[e60c872230cc4c421816d2a284c1da6e4d4db4fa]: tincbypop
| Year |    0.1 |  0.25 |  0.5 | 0.75 |  0.9 | 1 |
| 1972 | 0.0169 | 0.077 | 0.26 | 0.53 | 0.75 | 1 |
| 2016 | 0.0089 | 0.053 | 0.19 | 0.44 | 0.68 | 1 |

#+name: tincome1972
#+call: lucr(keys=1,years=1972,words="FALSE",docomprss="FALSE", format="%f")

#+RESULTS: tincome1972
: 9.884043e+12

#+name: tincome2016
#+call: lucr(keys=1,years=2016,words="FALSE",docomprss="FALSE", format="%f")
...
$​call_lucr(keys=1,years=1972,words="TRUE",docomprss="TRUE") in 1972
to $​call_lucr(keys=1,years=2016,words="TRUE",docomprss="TRUE") in
2016, an increase in
$​call_lucr(keys=1,years="1972,2016",words="TRUE").  Who got all this
money?  How was it shared among the population?
...
#+BEGIN_SRC R :tangle create.tiles :shebang "#!/usr/bin/env Rscript" :results none :eval no-export :exports none
  ...
  main <- function(args=NULL) {
    ...
    print(rval, row.names=FALSE, digits=2)
  }
