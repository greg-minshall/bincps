...
solid blue line floating "above" the bars) is the curve you would get
if you let the "width" of the histogram bins "go to" zero, i.e., get
thinner and thinner, approaching a limit.  In the FT display, in 1971,
...
In a case like the one we are looking at, 
...
reporting, as it is said to be the case that many "households" start
