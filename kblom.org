...
experiments) is to form a histogram, "binning" the possible values (so
...
of looking at, characterizing, a distribution, the "[[https://en.wikipedia.org/wiki/Cumulative_distribution_function][cumulative
